  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var placeholder = function placeholder() {
        return _react2.default.createElement('img', { src: 'http://www.tbaf.org.tw/event/2016safe/imgs/loader1.gif', style: itemStyle });
      };

      var placeholderHtml = function placeholderHtml() {
      ...
      var imageList = ['https://images2.alphacoders.com/521/521718.jpg', 'https://images5.alphacoders.com/587/587323.jpg', 'https://images4.alphacoders.com/378/3764.jpg', // removed 6 from 37864
      'https://images7.alphacoders.com/333/333205.jpg', 'https://images8.alphacoders.com/570/570189.jpg'];

      var imageList2 = ['https://images7.alphacoders.com/333/333198.jpg', 'https://images5.alphacoders.com/570/570618.jpg', 'https://images2.alphacoders.com/238/238870.jpg', 'https://images2.alphacoders.com/468/468.jpg', // error image modified from 4682
      'https://images3.alphacoders.com/191/19177.jpg'];

      var imageComponent = imageList.map(function (item) {
      ...
      var imageComponent2 = imageList2.map(function (item) {
        return _react2.default.createElement(_index2.default, {
          src: item,
 ...
 * @author krishcdbry
 */
var FancyImageloader = function (_React$Component) {
    _inherits(FancyImageloader, _React$Component);
     ...
     * @param {*} props 
     */
    function FancyImageloader(context, props) {
        _classCallCheck(this, FancyImageloader);

        var _this = _possibleConstructorReturn(this, (FancyImageloader.__proto__ || Object.getPrototypeOf(FancyImageloader)).call(this, context, props));
        ...
        var className = _this.props.class;

        style = Object.assign({}, style, _constants.fadeInObj); // For fadeIn/out animation when image source loads
        ...
        _this.state = {
            ...
            error: error,
            style: style,
            imageState: _constants.IMAGE_STATE_LOADING,
            src: src
        };
        return _this;
    }
    ...
    _createClass(FancyImageloader, [{
        key: '_imageLoaded',
        value: function _imageLoaded() {
            if (this.state.imageState == _constants.IMAGE_STATE_SUCCESS) {
                return;
            }
            this.setState({
                imageState: _constants.IMAGE_STATE_SUCCESS,
                style: Object.assign({}, this.state.style, _constants.fadeOutObj)
            });
        }
        ...
        key: '_imageFailed',
        value: function _imageFailed() {
            if (this.state.error == undefined) {
                return;
            }
            this.setState({
                imageState: _constants.IMAGE_STATE_FAILED
            });
        }
        ...
        key: '_simulateAsyncImage',
        value: function _simulateAsyncImage() {
            var _this2 = this;
        ...
        key: '_prepareProps',
        value: function _prepareProps() {
            var props = {};
            for (var prop in this.state.imageProps) {
                if (prop != undefined) {
        ...
        key: '_createPlaceholderHtml',
        value: function _createPlaceholderHtml(props) {
            return _react2.default.createElement(
                'span',
                props,
        ...
        */
        ...
        key: '_createErrorHTML',
        value: function _createErrorHTML(props) {
            return _react2.default.createElement(
                'span',
                props,
                this.state.error()
        ...
        */
        ...
        value: function _createImageElement(props) {
        ...
        value: function render() {
            ...
            var props = this._prepareProps();
            var renderElem = null;

            switch (this.state.imageState) {
                case _constants.IMAGE_STATE_LOADING:
                    renderElem = this._createPlaceholderHtml(props);
                    break;
                case _constants.IMAGE_STATE_SUCCESS:
                    renderElem = this._createImageElement(props);
                    setTimeout(function () {
                        var style = Object.assign({}, _this3.state.style, _constants.fadeInObj);
                        _this3.setState({
                            style: style
                        });
                    });
                    break;
                case _constants.IMAGE_STATE_FAILED:
...
FancyImageloader.propTypes = _constants.propTypes;
FancyImageloader.defaultProps = _constants.defaultProps;

exports.default = FancyImageloader;
...
exports.IMAGE_STATE_SUCCESS = exports.IMAGE_STATE_LOADING = exports.IMAGE_STATE_FAILED = exports.fadeOutObj = exports.fadeInObj = exports.defaultProps = exports.propTypes = undefined;
...
var IMAGE_STATE_LOADING = 'loading'; // Before image load/ While loading
var IMAGE_STATE_SUCCESS = 'success'; // Once successfully loaded
var IMAGE_STATE_FAILED = "failed"; // Image src failed / Invalid path

var propTypes = {
    src: _propTypes2.default.string.isRequired, // Source path of the image to be loaded + displayed 
    placeholder: _propTypes2.default.func.isRequired, // A Placeholder function which returns simple react element html/image to be dispayed before image loads/loading
    error: _propTypes2.default.func, // An optional error function which returns simple HTML/image to be displayed when image failed to load
    class: _propTypes2.default.string, // css class property for the image element
    width: _propTypes2.default.string, // width as string 100px, 200px etc
    height: _propTypes2.default.string, // Height attr same as width 100px, 200px etc
    alt: _propTypes2.default.string, // alt - Text information
    border: _propTypes2.default.string, // standered border styling - 0px solid etc.
    style: _propTypes2.default.object // styling object 
};
...
var fadeInObj = { // FadeIn animation when image loads
    opacity: "1",
...
exports.fadeInObj = fadeInObj;
exports.fadeOutObj = fadeOutObj;
exports.IMAGE_STATE_FAILED = IMAGE_STATE_FAILED;
exports.IMAGE_STATE_LOADING = IMAGE_STATE_LOADING;
exports.IMAGE_STATE_SUCCESS = IMAGE_STATE_SUCCESS;
